...
export const translations = {
  en: {
    ...
    owner_note: "🛡️ You'll be asked for a Civil ID photo when posting — it's kept private and only used to confirm you're a real owner.",
    ...
    f_idname: "Civil ID full name (as it appears on your ID)",
    f_idname_ph: "e.g. Ahmad Yousef Al-Sabah",
    f_idnumber: "Civil ID number (12 digits)",
    f_idphoto: "Civil ID photo (required — kept private, reviewed only by Sakan Customer Care)",
  ...
  ar: {
    ...
    owner_note: "🛡️ سيُطلب منك صورة البطاقة المدنية عند النشر — تُحفظ بسرية وتُستخدم فقط للتأكد من أنك مالك حقيقي.",
    ...
    f_photo: "صورة العقار",
    f_idname: "الاسم الكامل كما يظهر في البطاقة المدنية",
    f_idname_ph: "مثال: أحمد يوسف الصباح",
    f_idnumber: "الرقم المدني (12 رقمًا)",
    f_idphoto: "صورة البطاقة المدنية (مطلوبة — تُحفظ بسرية ويراجعها فريق خدمة عملاء سكن فقط)",
